    ...
    function stripEXIF(file) {
        ...
        reader.onload = (e) => {
            ...
            img.onload = () => {
                ...
                // Očuvanje bijele pozadine ako se PNG/WebP prebacuje u JPG ili ako slika ima providne dijelove
                ...
                canvas.toBlob((blob) => {
                    ...
                    // Generisanje ekstenzije za čisti fajl
                    const ext = targetType.split('/')[1] || 'jpg';
                    const baseName = file.name.substring(0, file.name.lastIndexOf('.')) || file.name;
                    const cleanFileName = `clean_${baseName}.${ext}`;
                    ...
                    item.innerHTML = `
                        <div class="result-info">
                            ...
                            <div class="result-meta">✓ EXIF & GPS stripped (${(blob.size / 1024).toFixed(1)} KB)</div>
                        </div>
                ...
                }, targetType, targetType === 'image/png' ? undefined : 0.92);
            };
